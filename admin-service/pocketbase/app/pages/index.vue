...
const updateLink = async () => {
  if (!pbAuth.value || !currentLinkId.value) return
...
const formatDateForInput = (isoString: string | null) => {
  ...
  // In memory notes: When filtering PocketBase collections by date, format JavaScript Date objects by replacing the 'T' separator with a space
  // Wait, that's for query filters. For input value 'datetime-local' we need standard local ISO.
